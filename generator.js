...
let newDict = {} 
for (let element of fileIcons["icons"]){
    if (element["fileExtensions"]){
        console.log("adding ",element["name"])
        for (let extension of element["fileExtensions"]){
            console.log("\t new extension",extension)
            newDict[extension] = element["name"]
        }     
    }
}

let jsonData = JSON.stringify(newDict)
console.log(jsonData)
fs.writeFileSync("generated.json", jsonData)
